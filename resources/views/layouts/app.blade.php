...
<body id="app-layout" class="nav-md">
   <div class="container body">
    <div class="main_container">
              ...
              <div class="menu_section">
                <ul class="nav side-menu">
					...
					@can('observationlibrary_view')
				 		<li><a href="{!! url('/observation/list') !!}" ><i class="fa fa-universal-access"></i>{{ trans('app.Work Orders')}}</a></li>
					@endcan
                </ul>
              </div>
            </div>
	   ...
	   <footer>
          <div>
             <span class="footerbottom">{{ trans('app.All rights reserved, Powered by HTU ICT DIRECTORATE.')}}</span>
          </div>
