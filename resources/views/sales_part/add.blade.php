        ...
        <div>
            ...
            <div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel">
						<div class="x_content">
							<form method="post" action="{!! url('/sales_part/store') !!}" enctype="multipart/form-data"  class="form-horizontal upperform salesPartAddForm">
									...
									<tbody>
										<tr id="row_id_1">
											<td class="tbl_td_selectManufac_error_1">
												...
												<select class="form-control select_producttype select_producttype_1" name="product[Manufacturer_id][]" m_url="{!! url('/purchase/producttype/names') !!}" row_did="1" data-id="1" id="" style="width:100%;" required>
												...
												<span id="select_producttype_error_1" class="help-block error-help-block color-danger" style="display: none">{{ trans('app.Manufacturer name is required.') }}</span>
											</td>
											<td class="tbl_td_selectProductname_error_1">
												<select name="product[product_id][]" class="form-control  productid select_productname_1" id="productid"  url="{!! url('purchase/add/getproduct')!!}" row_did="1" data-id="1" style="width:100%;" required="required">
												...
												<span id="select_productname_error_1" class="help-block error-help-block color-danger" style="display: none">{{ trans('app.Product name is required.') }}</span>
											</td>
											<td class="tbl_td_quantity_error_1">
												<input type="text" name="product[qty][]" url="{!! url('purchase/add/getqty')!!}" prd_url="{{url('/sale_part/get_available_product')}}" class="quantity form-control qty qty_1 qtyt" id="qty_1" autocomplete="off" row_id="1" value="" maxlength="8" style="width: 50%;" required>
												<span class="qty_1"></span>

												<span id="quantity_error_1" class="help-block error-help-block color-danger" style="display: none">{{ trans('app.Quantity is required.') }}</span>
											</td>
											<td class="tbl_td_price_error_1">
												...
												<span id="price_error_1" class="help-block error-help-block color-danger" style="display: none">{{ trans('app.Price is required.') }}</span>
											</td>
											<td class="tbl_td_totaPrice_error_1">
												...
												<span id="total_price_error_1" class="help-block error-help-block color-danger" style="display: none">{{ trans('app.Total price is required.') }}</span>
											</td>
											<td align="center">
						...
						<!-- End Custom Field -->
							...
							<div class="form-group">
								<div class="col-md-12 col-sm-12 col-xs-12 text-center">
									...
									<button type="submit" class="btn btn-success salesPartAddSubmitButton">{{ trans('app.Add')}}</button>
								</div>
							</div>
							</form>
						</div>
