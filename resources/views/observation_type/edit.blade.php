...
<!-- page content -->
		...
		@endif
           ...
           <li role="presentation" class=""><a href="{!! url('/observation_type/add')!!}"><span class="visible-xs"></span><i class="fa fa-plus-circle fa-lg">&nbsp;</i>{{ trans('app.Add Observation Type')}}</span></a></li>
			 ...
			 <li role="presentation" class="active"><a href="{!! url('/observation_type/list/edit/'.$editid)!!}"><span class="visible-xs"></span><i class="fa fa-pencil-square-o" aria-hidden="true">&nbsp;</i><b>{{ trans('app.Edit Observation Type')}}</b></span></a></li>
            </ul>
			</div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                   ...
                   <div class="x_content">
                    ...
                    <form method="post" action="update/{{$o_type_point->id}}" enctype="multipart/form-data"  class="form-horizontal upperform">
					   ...
					   <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback" style="margin-top:15px;">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
						 ...
						 <input type="text" id="o_type" name="o_type"  class="form-control" value="{{$o_type_point->type}}" required>
                        </div>
                      </div>
