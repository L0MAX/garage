    ...
    <div class="right_col" role="main">
	    ...
	    <div class="x_content">
            <ul class="nav nav-tabs bar_tabs tabconatent" role="tablist">
				...
				@endcan
			 	@can('accountant_edit')
					<li role="presentation" class="active"><a href="{!! url('/accountant/list/edit/'.$editid)!!}"><span class="visible-xs"></span><i class="fa fa-pencil-square-o" aria-hidden="true">&nbsp;</i> <b>{{ trans('app.Edit Accountant')}}</b></a></li>
				@endcan

				@if(getUserRoleFromUserTable(Auth::User()->id) == 'accountant')
						...
						<div class="x_content">
							<form id="accountant_edit_form" action="update/{{ $accountant->id }}" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left input_mask">
                      			...
                      			<div class="col-md-12 col-xs-12 col-sm-12 space">
					  				<h4><b>{{ trans('app.Accountant Information')}}</b></h4>
							...
							<div class="col-md-12 col-sm-6 col-xs-12">
							  	<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group has-feedback {{ $errors->has('firstname') ? ' has-error' : '' }}">
		                        	...
		                        	<div class="col-md-8 col-sm-8 col-xs-12">
		                          		<input type="text" id="firstname" name="firstname" placeholder="{{ trans('app.Enter First Name')}}" value="{{$accountant->name}}" class="form-control" maxlength="50">
							  	...
							  	<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group has-feedback {{ $errors->has('lastname') ? ' has-error' : '' }}">
		                        	...
		                        	<div class="col-md-8 col-sm-8 col-xs-12">
		                          		<input type="text" id="lastname"  name="lastname" placeholder="{{ trans('app.Enter Last Name')}}" value="{{$accountant->lastname}}" class="form-control" maxlength="50">
		                    ...
		                    <div class="col-md-12 col-sm-6 col-xs-12">
							  	<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group has-feedback {{ $errors->has('displayname') ? ' has-error' : '' }}">
		                        	...
		                        	<div class="col-md-8 col-sm-8 col-xs-12">
		                          		<input type="text"  name="displayname" id="displayname" placeholder="{{ trans('app.Enter Display Name')}}" value="{{$accountant->display_name}}" maxlength="25" class="form-control ">
		                    ...
		                    <div class="col-md-12 col-sm-6 col-xs-12">
		                        	...
		                        	<div class="col-md-8 col-sm-8 col-xs-12 input-group date datepicker">
										<span class="input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
		                          		@if($accountant->birth_date)
		                          			<input type="text" id="date_of_birth" autocomplete="off" class="form-control" placeholder="<?php echo getDateFormat();?>" value="{{date(getDateFormat(),strtotime($accountant->birth_date))}}" name="dob" onkeypress="return false;">
		                          		@else
							  	...
							  	<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group has-feedback {{ $errors->has('email') ? ' has-error' : '' }}">
		                        	...
		                        	<div class="col-md-8 col-sm-8 col-xs-12">
		                          		<input type="text"  name="email" placeholder="{{ trans('app.Enter Email')}}" value="{{$accountant->email}}" maxlength="50" class="form-control ">
	          						  	@if ($errors->has('email'))
	          						   	<span class="help-block">
							...
							<div class="col-md-12 col-sm-6 col-xs-12">
							   	<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group has-feedback {{ $errors->has('mobile') ? ' has-error' : '' }}">
		                        	...
		                        	<div class="col-md-8 col-sm-8 col-xs-12">
		                          		<input type="text"  name="mobile" placeholder="{{ trans('app.Enter Mobile No')}}" value="{{$accountant->mobile_no}}"  class="form-control" maxlength="16" minlength="6">
							  	...
							  	<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group has-feedback {{ $errors->has('landlineno') ? ' has-error' : '' }}">
		                        	...
		                        	<div class="col-md-8 col-sm-8 col-xs-12">
		                          		<input type="text" id="landlineno" name="landlineno" placeholder="{{ trans('app.Enter LandLine No')}}" value="{{$accountant->landline_no}}"  class="form-control" maxlength="16" minlength="6">
							...
							<div class="col-md-12 col-sm-6 col-xs-12">
							   	<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
		                        	<label class="control-label col-md-4 col-sm-4 col-xs-12" for="city">{{ trans('app.Town/City') }}      </label>
		                         	<div class="col-md-8 col-sm-8 col-xs-12">
		                          		<select class="form-control  city_of_state" name="city">		@if($city != null)
