					...
					<nav>
						<div class="nav toggle">
							<a id="menu_toggle">
								...
								<span class="titleup">&nbsp {{ trans('app.Support Staff')}}</span>
							</a>
						</div>
		...
		<div class="x_content">
            <ul class="nav nav-tabs bar_tabs tabconatent" role="tablist">
				...
				@can('supportstaff_add')
					<li role="presentation" class="active setTabAddSupportStaffOnSmallDevice"><a href="{!! url('/supportstaff/add')!!}"><span class="visible-xs"></span><i class="fa fa-plus-circle fa-lg">&nbsp;</i> <b>{{ trans('app.Add Supportstaff') }}</b></a></li>
				@endcan
			</ul>
		</div>
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
					<div class="x_content">
						<form id="supportstaff_add_form" action="{!! url('/supportstaff/store')!!}" method="post"
						enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left input_mask supportSttafAddForm">
							<div class="col-md-12 col-xs-12 col-sm-12 space">
								<h4><b>{{ trans('app.Supporting Staff Information')}}</b></h4>
