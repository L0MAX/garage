...
th {
	...
	<div class="row">
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">			
				...
				<table class="table table-bordered" id="adddatatable1" width="100%" border="1"  style="border-collapse:collapse;">
					<thead>
						<tr> 
					...
					<tbody>
						<tr>
							...
							<td class="cname text-center"><?php if(!empty($s_date->registration_no)){echo $s_date->registration_no; }else{ echo $vehical->registration_no;} ?> </td>
				...
				<table class="table table-bordered " id="adddatatable2" width="100%" border="1"  style="border-collapse:collapse;">
					<thead>
						<tr>
				...
				<table class="table table-bordered" id="adddatatable3" width="100%" border="1" style="border-collapse:collapse;">
					<thead>		
						<tr>
			    ...
			    <table class="table table-bordered" width="100%" border="1" style="border-collapse:collapse;">
					<tr class="printimg">
						<td class="cname" colspan="7"><b>{{ trans('app.OTHER SERVICE CHARGES')}}</b></td>
					</tr>
				</table>
				
				<table class="table table-bordered adddatatable4" id="adddatatable4" width="100%" border="1" style="border-collapse:collapse;">
					<thead>		
						<tr>
							<th class="text-center">#</th>
	...
	<div class="modal-footer">
		...
		<input type="submit" class="btn btn-default printbtn" id="" onclick="printdiv('sales_print')" value="{{ trans('app.Print')}}">
		
		 <a href="" class="prints"><input type="submit" class="btn btn-default" value="{{ trans('app.Close')}}"> </a>
    </div>
                        <!-- /.col -->
