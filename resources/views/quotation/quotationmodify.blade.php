      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
         <div class="x_content">
            <ul class="nav nav-tabs bar_tabs tabconatent customTabWidth" role="tablist">
               @can('quotation_view')
                  <li role="presentation" class=""><a href="{!! url('/quotation/list')!!}"><span class="visible-xs" ></span><i class="fa fa-list fa-lg">&nbsp;</i>{{ trans('app.Quotation List')}}</span></a></li>
               @endcan
               @can('quotation_edit')
                  <li role="presentation" class="active"><a href="{!! url('/quotation/list/modify/'.$services->id)!!}" class="process"><span class="visible-xs"></span><i class="fa fa-plus-circle fa-lg i">&nbsp;</i><b>{{ trans('app.Quotation Process')}}</b></span></a></li>
               @endcan
            </ul>
         </div>
      </div>
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
         <div class="x_panel">
            <!-- <div class="well well-sm titleup">
               {{ trans('app.Processing Job for...'). getQuotationNumber($services->job_no)}}
            </div> -->
            <form method="post" action="{!! url('/quotation/add_modify_quotation') !!}" class="addJobcardForm">
               ...
               <div class="col-md-12 col-xs-12 col-xs-12">
                  ...
                  <div class="col-md-5 col-xs-12 col-sm-12">
                     <div class="col-md-12 col-xs-12 col-sm-12">
                        <label class="control-label jobcardmargintop col-md-4 col-sm-12 col-xs-12">{{ trans('app.Quotation No')}} <label class="color-danger">*</label></label>
                     ...
                     <!-- <div class="col-md-12 col-xs-12 col-sm-12" style="margin-top:5px;">
                        ...
                        <div class="col-md-8 col-sm-12 col-xs-12 input-group date datepicker">
                           ...
                           <input type="text" id="out_date" name="out_date" autocomplete="off"
                              value="<?php if(!empty($job->out_date)){ echo date( getDateFormat().' H:i:s',strtotime($job->out_date));} ?>" class="form-control" placeholder="<?php echo getDatepicker(); echo " hh:mm:ss"; ?>" readonly required >
                        </div>
                     </div> -->
                  </div>
               </div>
      ...
      <!-- End MOT Test Checking -->
            ...
            <!-- model in observation Point -->
               ...
               <div class="col-md-12 col-xs-12 col-sm-12" style="margin-top:5px; margin-bottom:15px;">
                  <div class="col-md-8 col-sm-12 col-xs-12">
                     <label>
                     <input type="checkbox" id="finalSubmit" name="finalSubmit" class="" style="height:20px; width:20px; margin-right:5px; position: relative; top: 6px; margin-bottom: 12px;">
                       <span for="finalSubmit" class="text-danger">{{ trans('app.Quotaion is final, then click here.')}}</span>
                     </label>
                  </div>
               </div>
