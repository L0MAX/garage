                 ...
                 <table class="table table-bordered addtaxtype" id="tab_products_detail" align="center">
                   ...
                   <tbody>
                     ...
                     <tr id="<?php echo'row_id_'.$id; ?>">
                        <td>
                          <input type="text" name="other_product[]" class="form-control othr_prod_<?php echo $id; ?>" value="<?php echo $product->comment;?>" id="othr_prod_<?php echo $id; ?>" othr_prod="<?php echo $product->id;?>" >
                        </td>
                        <td>
                          <input type="text" name="other_price[]" class="form-control othr_price_<?php echo $id; ?>" id="oth_price" value="<?php echo $product->total_price; ?>" >
                        </td>
                        <td>
