              		...
              		<div class="">
                		<ul class="nav nav-tabs bar_tabs tabconatent" role="tablist">
	                     	@can('observationlibrary_view')
								<li role="presentation" class="suppo_llng_li floattab"><a href="{!! url('/observation/list')!!}"><span class="visible-xs"></span><i class="fa fa-list fa-lg">&nbsp;</i> {{ trans('app.Work Order List')}}</a></li>
							@endcan
							@can('observationlibrary_add')
								<li role="presentation" class="active suppo_llng_li_add floattab"><a href="{!! url('/observation/add')!!}"><span class="visible-xs"></span> <i class="fa fa-plus-circle fa-lg">&nbsp;</i><b>{{ trans('app.Add Work Order')}}</b></a></li>
							@endcan
						</ul>
                		<div class="clearfix"></div>
              		</div>
                 			...
                 			<input type="hidden" name="_token" value="{{csrf_token()}}">
                  			...
                  			<div class="items">
                  				<div class="form-group my-form-group parentClass_1 {{ $errors->has('checkpoint') ? ' has-error' : '' }}">
									...
									<div class="col-md-5 col-sm-5 col-xs-12">
                  						<input id="author_email" placeholder="{{ trans('app.Enter Checkpoint Name')}}" name="checkpoint[]" maxlength="255" type="text" class="form-control checkpoint checkpointsData" required="true" disabled="true" rowid="1">
					...
					<div class="col-md-12 col-sm-12 col-xs-12 form-group">
						<div class="col-md-12 col-sm-12 col-xs-12 form-group">
						  	...
						  	<div class="col-md-6 col-sm-6 col-xs-12">
								<input id="cat" placeholder="{{ trans('app.Enter Checkpoint Name')}}" name="category" type="text" class="form-control add_newcat" value="" maxlength="255" required />
						  	</div>
						</div>
					</div>
					<div class="col-md-12 col-sm-12 col-xs-12 form-group">
