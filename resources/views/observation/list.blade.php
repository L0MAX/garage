      ...
      <div class="nav_menu">
        <nav>
          <div class="nav toggle">
            <a id="menu_toggle"><i class="fa fa-bars"></i><span class="titleup">&nbsp {{ trans('app.Work Order')}}</span></a>
          </div>
        ...
        <div class="x_content">
          <ul class="nav nav-tabs bar_tabs tabconatent" role="tablist">
            @can('observationlibrary_view')
              <li role="presentation" class="active suppo_llng_li floattab"><a href="{!! url('/observation/list')!!}"><span class="visible-xs"></span><i class="fa fa-list fa-lg">&nbsp;</i><b>{{ trans('app.Work Order List')}}</b></a></li>
            @endcan
            @can('observationlibrary_add')
              <li role="presentation" class="suppo_llng_li_add floattab"><a href="{!! url('/observation/add')!!}"><span class="visible-xs"></span><i class="fa fa-plus-circle fa-lg">&nbsp;</i>{{ trans('app.Add Work Order')}}</a></li>
            @endcan
          </ul>
        </div>
                                          ...
                                          <div class="form-group">
                                             <table class="table table-striped">
                                                <thead>
                                                   <tr>
                                                      <td><b>#</b></td>
                                                      <td><b>{{ trans('app.Work Order')}}</b></td>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">{{ trans('app.Edit Work Order')}}</h4>
            </div>
...
<script>
   ...
   x++;
   $(wrapper).append('<div class="form-group"><label class="control-label col-md-4 col-sm-3 col-xs-12">{{ trans('app.Work Order') }}<label class="" style="color: #a94442;">&nbsp;&nbsp;*</label></label>' +
   '<input class="form-control col-md-7 col-xs-12" idid="chek_pt" type="text" placeholder="{{ trans('app.Enter Services Name')}}" name="checkpoint[]" required="true" style="width:48% !important;"/>' + '&nbsp;&nbsp;'+'<a href="#" class="remove_field"><i class="fa fa-times" style="margin-top:10px !important;"></a></div>');
   }
   });
