...
EOT;
    ...
    protected function addImagePngAlpha($file, $x, $y, $w, $h, $byte)
    {
        ...
        $tempfile_alpha = "$tempfile_alpha.jpg";

        // create temp plain file
        $tempfile_plain = @tempnam($this->tmp, "cpdf_img_");
        @unlink($tempfile_plain);
        $tempfile_plain = "$tempfile_plain.jpg";
        ...
        if (extension_loaded("gmagick")) {
            ...
            $alpha_channel->newimage($wpx, $hpx, "#FFFFFF", "jpg");
            ...
            $color_channels->newimage($wpx, $hpx, "#FFFFFF", "jpg");
        ...
        // remove temp files
        if ($tempfile_alpha) {
            unlink($tempfile_alpha); //dd($tempfile_plain);
        }
        unlink($tempfile_plain);
    }
