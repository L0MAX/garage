...
//			}
		...
		if(!empty($type == 2))
		{
				...
				$pdf = PDF::loadView('invoice.sales_partinvoicepdfl',compact('viewid','products_data','salespart','logo','invioce','taxes'));//dd($pdf);

				$str = "abcdefghijklmnopqrstuvwxyz";
				$str1 = str_shuffle($str);

				$t=$pdf->save('public/pdf/sales/'.$str1.'.pdf'); dd($str1);
	...
	public function sale_part_store(Request $request)
	{
		...
		if(!empty($type == 2))
		{
				...
				$pdf->save('public/pdf/sales/'.$file);
